...
function preload() {
    game.load.image('lava','assets/Volcano.jpg');
    game.load.image('magma','assets/Lava.png');
...
function create() {
    ...
    game.add.sprite(0,0,'lava');
    platforms=game.add.group();
    platforms.enableBody=true;
    var ground=platforms.create(0,660,'magma');
    ground.scale.setTo(0.3,0.35);
    ground.body.immovable=true;
 ground=platforms.create(300,660,'magma');
    ground.scale.setTo(0.3,0.35);
    ground.body.immovable=true;
 ground=platforms.create(800,660,'magma');
    ground.scale.setTo(0.7,0.35);
    ground.body.immovable=true;
    
    
    var ledge=platforms.create(21,340,'magma');
    ...
    ledge = platforms.create(600, 480, 'magma');
    ...
    ledge = platforms.create(150, 530, 'magma');
    ledge.scale.setTo(0.05,0.9);
    ledge.body.immovable = true;

    
        ledge = platforms.create(350, 530, 'magma');
    ledge.scale.setTo(0.05,0.9);
    ledge.body.immovable = true;
    
    ledge=platforms.create(780,210,'magma');
    ledge.body.immovable = true;
        ledge.body.velocity.setTo(-190,0);
    ledge.body.immovable=true;
    ledge.body.collideWorldBounds = true;
    ledge.body.bounce.set(0.9);
     ledge.scale.setTo(0.4,0.2);
    ...
    ledge=platforms.create(800,100,'magma');
