...
function preload() {
    game.load.image('island','assets/Island.jpg');
...
function create() {
    ...
    game.add.sprite(0,0,'island');
    platforms=game.add.group();
    platforms.enableBody=true;
    var ground=platforms.create(0,660,'ground');
    ground.scale.setTo(1.90,0.35);
    ground.body.immovable=true;
    var ledge=platforms.create(21,340,'ground');
        ledge.scale.setTo(1,0.2);
    ledge.body.immovable = true;
    ledge = platforms.create(600, 500, 'ground');
            ledge.scale.setTo(0.7,0.2);
    ledge.body.immovable = true;
